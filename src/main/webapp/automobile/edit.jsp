			...
			<div class='card'>
			    ...
			    <div class='card-body'>
					...
					<h6 class="card-title">I campi con <span class="text-danger">*</span> sono obbligatori</h6>
						...
						<form method="post" action="ExecuteModificaAutomobileServlet" novalidate="novalidate">
							...
							<div class="form-row">
								<div class="form-group col-md-6">
									...
									value="${edit_attribute.marca}" placeholder="Inserire la marca da modificare" required autofocus>
								...
								<div class="form-group col-md-6">
									...
									value="${edit_attribute.modello}" placeholder="Inserire il modello da modificare" required autofocus>
							...
							<div class="form-row">	
								<div class="form-group col-md-6">
									...
									value="${edit_attribute.cilindrata}" placeholder="Inserire la cilindrata da modificare"  required autofocus>
									
								</div>
								<div class="form-group col-md-3">
									<fmt:formatDate type="date" pattern="yyyy-MM-dd" value="${edit_attribute.dataImmatricolazione}" var="dataPubblParsed"/>
									<label>Data Immatricolazione<span class="text-danger">*</span></label>
		                         	...
		                         	title="formato : gg/mm/aaaa" value="${dataPubblParsed}" name="dataImmatricolazione" required>
							...
							<button type="submit" name="submit" value="submit" id="submit" class="btn btn-primary" style='width:7em;'>Modifica</button>
			      			<input type="hidden" name="idEditInput" value="${edit_attribute.id}">
